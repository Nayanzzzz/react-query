...
// import { addFormSchema } from "./add-form-schema";
...
//     },
//     onSuccess: (data) => {
//       // Append to existing employee list or create it
...
//       <p className="text-center pb-10 text-2xl">ADD EMPLOYE</p>
...
//                     <FormItem className="">
//                       <FormControl>
//                         <RadioGroupItem value="regular" className="" />
//                       </FormControl>
...
import { v4 as uuidv4 } from "uuid";
import { addFormSchema } from "./add-form-schema"; 
import EmployeeForm from "@/app/employ-listing/_components/empoly-form"; 
